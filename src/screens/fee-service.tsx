	...
	return (
		<FixedContainer>
			...
			<TouchableOpacity
				...
				style={{backgroundColor: colors.appColor, borderRadius: 5, alignSelf: 'flex-end', padding: 5, marginHorizontal: 20}}>
				<CustomText font={FONT_FAMILY.BOLD} text={'Xác Minh'} />
			</TouchableOpacity>

			<CustomText text={'Phí Hàng Tháng: 50.000 VND/Tháng'} style={{textAlign: 'center', paddingVertical: heightScale(10)}} />
			...
			<View style={{marginLeft: widthScale(40)}}>
				<CustomText text={'STK: 9999999'} style={{paddingVertical: heightScale(10)}} />
				<CustomText text={'Ngân hàng: MB'} style={{paddingVertical: heightScale(10)}} />
				<CustomText text={'Chủ thẻ: Quy Đăng'} style={{paddingVertical: heightScale(10)}} />
				<CustomText text={'Nội dung: Chuyển khoản phí dịch vụ'} style={{paddingVertical: heightScale(10)}} />
			</View>
			<Modal
